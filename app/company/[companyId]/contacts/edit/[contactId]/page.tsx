...
import { getContactAPI, updateContactAPI } from "@/services/handleApi";
...
const ContactEditPage = () => {
  ...
  const fetchContactDetails = async () => {
    try {
      const companyData = await getContactAPI(contactId);
      setFormData({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      addToast({
        title: "Failed to update contact. Please try again.",
        color: "danger",
        radius: "sm",
        variant: "flat",
        timeout: 3000,
      ...
      <Card className="max-w-4xl mx-auto" radius="sm">
        <CardHeader className="flex flex-col gap-2">
          ...
          <p className="text-gray-500">
            Fill in the details below to edit a contact profile.
          </p>
        </CardHeader>
