...
import { getCompanyAPI, updateCompanyAPI } from "@/services/handleApi";
...
const CompanyEditPage = () => {
  ...
  const fetchCompanyDetails = async () => {
    try {
      const companyData = await getCompanyAPI(companyId);
      setFormData({
        name: companyData.name,
        website: companyData.website,
        websiteTechStack: companyData.websiteTechStack,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      addToast({
        title: "Failed to update company. Please try again.",
        color: "danger",
        radius: "sm",
        variant: "flat",
        timeout: 3000,
      ...
      <Card className="max-w-4xl mx-auto" radius="sm">
        <CardHeader className="flex flex-col gap-2">
          ...
          <p className="text-gray-500">
            Fill in the details below to edit a company profile.
          </p>
        </CardHeader>
